...
func usage() {
	fmt.Fprintln(os.Stderr, "usage: flowbee <init|doctor|board|status|autonomy|spec|repo|card|up|fleet|serve|token|migrate|work|lease|submit|requeue|cancel|retry-outbox|backup|build|restore|pause|resume|seed|version>")
}
