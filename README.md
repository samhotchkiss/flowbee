...
Go deeper: **[docs/architecture-overview.md](./docs/architecture-overview.md)** — high-level map of the system (start here) · **[docs/glossary.md](./docs/glossary.md)** — definitions of Flowbee terms · **[DESIGN.md](./DESIGN.md)** — the full architecture · **[BUILD.md](./BUILD.md)** — the milestone plan.
