...
Run it: **[docs/operating.md](./docs/operating.md)** — stand up a control plane + fleet and feed it work · **[docs/preflight.md](./docs/preflight.md)** — the go-live checklist to run before pointing Flowbee at a live repo (`flowbee doctor` automates most of it) · **[docs/metrics.md](./docs/metrics.md)** — Prometheus metrics reference · **[docs/faq.md](./docs/faq.md)** — quick answers to the questions new operators ask first · **[docs/troubleshooting.md](./docs/troubleshooting.md)** — confirm and fix common failure modes · **[docs/pipeline.md](./docs/pipeline.md)** — the stages a change moves through · **[docs/config.md](./docs/config.md)** · **[docs/identities.md](./docs/identities.md)** · **[docs/security-model.md](./docs/security-model.md)** — threat model and guardrails · **[docs/email-policy-engine.md](./docs/email-policy-engine.md)** — reviewed spec for email per-class auto-handling · **[docs/mail-processing-trace.md](./docs/mail-processing-trace.md)** — internal contract for exact per-message mail trace debugging · **[docs/glossary.md](./docs/glossary.md)** — definitions of Flowbee terms · **[docs/deploy/multi-repo.md](./docs/deploy/multi-repo.md)**.
